...
export const Profile = ({ navigation }) => {
  ...
  const signOut = async () => {
    ...
    try {
      const user = await AsyncStorage.multiRemove([AsyncStorageKey.id, userID])
        ...
        <View style={styles.profileContainer}>
          ...
          {isUserSignedIn === true ? (
            <View style={styles.signInButton}>
              <Text style={styles.menuText}>{userData ? userData.email : 'No Email'}</Text>
            </View>
          ) : (
          ...
          <ScrollView showsHorizontalScrollIndicator={false}>
            {isUserSignedIn === true ? (
              <View style={styles.menuWrapper}>
                <TouchableOpacity onPress={() => navigation.navigate(ScreenName.favorites)}>
                  <View style={styles.menuItem}>
                    <MCIcon
                      name={Icon.profileFavorites}
                      size={Size.icon}
                      color={Color.primary}
                    />
                ...
                <TouchableOpacity onPress={() => navigation.navigate(ScreenName.orders)}>
                  <View style={styles.menuItem}>
                    <MCIcon
                ...
                <TouchableOpacity onPress={() => navigation.navigate(ScreenName.cart)}>
                  <View style={styles.menuItem}>
                    <SLIcon
