...
import { AsyncStorageKey, Color, FieldType, Icon, ScreenName, Size } from '../../constants'
  ...
  const signIn = async (values) => {
    ...
    try {
      ...
      if(response.status === 200) {
        ...
        await AsyncStorage.setItem(`${AsyncStorageKey.user}${responseData._id}`, JSON.stringify(responseData))
        await AsyncStorage.setItem(AsyncStorageKey.id, JSON.stringify(responseData._id))
                  ...
                  <View style={styles.wrapper}>
                    ...
                    <View style={touched.password ? styles.activeInputWrapper : styles.inactiveInputWrapper}>
                      ...
                      <TouchableOpacity onPress={() => setObsecureText(!obsecureText)}>
                        <MTIcon
                          name={obsecureText ? Icon.hidePassword : Icon.showPassword}
